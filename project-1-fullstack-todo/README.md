...
# **Жоба 1/10: Full-Stack To-Do List**

Бұл Next.js фронтенді мен FastAPI бэкендінен тұратын минималистік, бірақ толыққанды full-stack веб-қосымша. Ол қазіргі заманғы веб-әзірлеу архитектурасын түсінуге арналған практикалық үлгі ретінде қызмет етеді.

---

**🚀 Технологиялар стегі:**

* **Фронтенд**: Next.js (React, TypeScript және Tailwind CSS қолдана отырып)
* **Бэкенд**: FastAPI (асинхронды Python фреймворкі)
* **Пакет менеджері**: PNPM
* **Дерекқор**: Python жадындағы тізім (сервер қайта іске қосылғанда қалпына келтіріледі)

**✨ Мүмкіндіктер:**

* **Құру**: Тізімге жаңа тапсырмалар қосу.
* **Оқу**: Барлық ағымдағы тапсырмаларды көру.
* **Жаңарту**: Тапсырмаларды шерту арқылы «орындалды» деп белгілеу.
* **Жою**: Тізімнен тапсырмаларды жою.
* **CORS қосулы**: Бэкенд фронтендтен сұраныстарды қабылдауға конфигурацияланған.

# **Сенің міндетің:**

Бұл жобаны клондап, оның функционалдығын кеңейт. Бұл өз дағдыларыңды жетілдірудің тамаша тәсілі!

# **Сенің тапсырмаң:**

# 1. **Клондау және іске қосу:**
> * ## Бұл репозиторийді жергілікті машинаңа клонда.
> * ## Фронтенд пен бэкендті іске қосу үшін орнату нұсқауларын орында.

# 2. **"Өңдеу" функциясын қосу:**
> * ## **Бэкенд**: `backend/main.py` файлында бар тапсырманың мәтінін өзгертуге мүмкіндік беретін жаңа `PUT /api/todos/{todo_id}` соңғы нүктесін жаса.
> * ## **Фронтенд**: Әр тапсырманың жанына "Өңдеу" батырмасын қос. Шерткен кезде ол пайдаланушыға тапсырманың мәтінін өзгертуге және өзгерістерді сақтауға мүмкіндік беруі керек, жаңа бэкенд соңғы нүктеңді шақыра отырып.

# 3. **"Барлық орындалғандарды тазалау" батырмасын қосу:**
> * ## **Бэкенд**: Орындалды деп белгіленген барлық тапсырмаларды жоятын `DELETE /api/todos/completed` соңғы нүктесін іске қос.
> * ## **Фронтенд**: Бірнеше тапсырманы бірден жою үшін осы жаңа соңғы нүктені шақыратын батырманы қос.

# 4. **Стильдеуді жақсарту:**
